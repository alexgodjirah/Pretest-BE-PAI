...
export default function TestiSwiper() {
    ...
    return (
        <>
            ...
            >
                <SwiperSlide className="testiSwiper--container">
                    <div>
                        <p className="font--h4">
                            "I'm very happy with thie product (WS), because from
                    ...
                    <div className="container--footer">
                        ...
                        <div className="footer--detail">
                            <h4 className="font--h4">Frans</h4>
                            <p className="font--p">
                                Coffee Farmer, Rimba Candi, Pagar Alam, South
                                Sumatra
                            </p>
                        </div>
                    </div>
                ...
                <SwiperSlide className="testiSwiper--container">
                    <div>
                        <p className="font--h4">
                            "I have used WS twice to help control the weeds in m
                    ...
                    <div className="container--footer">
                        <div className="footer--pic"></div>
                        <div className="footer--detail">
                            <h4 className="font--h4">Giyono</h4>
                            <p className="font--p">
                                Coffee Farmer, Talang Ternak Village, Pagar
                                Alam, South Sumatra
                            </p>
                        </div>
                    </div>
                ...
                <SwiperSlide className="testiSwiper--container">
                    <div>
                        <p className="font--h4">
                            "First time I tried using PS was when I tried to do
                    ...
                    <div className="container--footer">
                        <div className="footer--pic"></div>
                        <div className="footer--detail">
                            <h4 className="font--h4">Ngadini</h4>
                            <p className="font--p">
                                Farmer, Sukamulya Village, North Dempo, Pagar
                                Alam-South Sumatra
                            </p>
                        </div>
                    </div>
                ...
                <SwiperSlide className="testiSwiper--container">
                    <div>
                        <p className="font--h4">
                            "I remember when first time I used PS was when my
                    ...
                    <div className="container--footer">
                        <div className="footer--pic"></div>
                        <div className="footer--detail">
                            <h4 className="font--h4">Nur Alam</h4>
                            <p className="font--p">
                                Farmer, Tanjung Pring Village, Indralaya, Ogan
                                Ilir-South Sumatra
                            </p>
                        </div>
                    </div>
                ...
                <SwiperSlide className="testiSwiper--container">
                    <div>
                        <p className="font--h4">
                            "I pretty much used herbicides on my coffee plant. I
                ...
                <SwiperSlide className="testiSwiper--container">
                    <div>
                        <p className="font--h4">
                            "Several times ago, I heard from my friends that
                    ...
                    <div className="container--footer">
                        <div className="footer--pic"></div>
                        <div className="footer--detail">
                            <h4 className="font--h4">Wahid</h4>
                            <p className="font--p">
                                Horticuture and Coffee Farmer, Rimba Candi,
                ...
                <SwiperSlide className="testiSwiper--container">
                    <div>
                        <p className="font--h4">
                            "I have used WS three times on my coffee farm since
